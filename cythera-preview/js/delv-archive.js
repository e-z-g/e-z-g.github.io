 ...
 * uses, and before delv-graphics.js and delv-script.js.
 *
...
function extractDelverArchive(bytes) {
  const notes = [];
  ...
  throw new Error('Not a Delver archive: ' + notes.join('; ') +
    '. Expected "Cythera Data" itself, or a .hqx / MacBinary / AppleSingle wrapper around it.');
}
